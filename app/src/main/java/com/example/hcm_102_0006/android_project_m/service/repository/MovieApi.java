...
public interface MovieApi {
    ...
    @GET("/movie/{category}?api_key=" + DeveloperKey.KEY_MOVIE_API)
    ...
    @GET("/genre/movie/list?api_key=" + DeveloperKey.KEY_MOVIE_API)
    Observable<GenreResponse> getGenres();

    // get movie genres
    @GET("/genre/{genre_id}/movies?api_key=" + DeveloperKey.KEY_MOVIE_API + "&language=en-US&include_adult=false&sort_by=created_at.asc")
    Observable<ResultResponse> getMovieGenres(@Path("genre_id") String genreId);

    // get movie detail /movie/{movie_id}
    @GET("/movie/{movie_id}?api_key=" + DeveloperKey.KEY_MOVIE_API+"&append_to_response=videos")
    Observable<MovieDetail> getMovieDetail(@Path("movie_id") String movieId);

    // Get videos
    //get /movie/{movie_id}/videos
    @GET("/movie/{movie_id}/videos?api_key=" + DeveloperKey.KEY_MOVIE_API)
    ...
    @GET("/company/{company_id}/movies?api_key=" + DeveloperKey.KEY_MOVIE_API + "&language=en-US")
